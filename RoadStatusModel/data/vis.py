...
class Viewer():
    def __init__(self, root_path):
        ...
        self.dirs = sorted_alphanumeric(os.listdir(root_path))[1100:1110]
        self.curr_i = 0
        self.set_curr_dirs()
    ...
    def view(self):
        ...
        while True:
            ...
            cv2.putText(img, f"{os.path.basename(self.curr_dir)} {idx}",(10, 20),cv2.FONT_HERSHEY_SIMPLEX,0.6,(0, 255, 0), 2)
